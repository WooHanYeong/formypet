...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '나비엠알오 고양이사료'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이방석/쿠션 도넛마약'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이방석/쿠션 바잇미'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이방석/쿠션 소소네코'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이방석/쿠션 아르르'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이방석/쿠션 위드펫'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이방석/쿠션 페스텝'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이이동가방 바잇미'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이이동가방 제이피'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이이동가방 타임리스'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이샴푸/비누 그린태비'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이샴푸/비누 수솝'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이샴푸/비누 아인솝'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이샴푸/비누 프롬한라'
);
...
WHERE NOT EXISTS (
    SELECT 1 
    FROM product 
    WHERE PRODUCT_NAME = '고양이장난감 에코펫위드'
);
